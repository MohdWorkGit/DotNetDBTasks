...
```
dotnet publish tools\Bayan.QueryRunner -c Release -o C:\Tools\QueryRunner
```
...
```
Bayan.QueryRunner.exe                     # uses appsettings.json next to the exe
Bayan.QueryRunner.exe C:\Jobs\sales.json  # or any config file you pass
```
...
4. Actions → New:
   - **Program/script:** `C:\Tools\QueryRunner\Bayan.QueryRunner.exe`
